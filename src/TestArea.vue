<template>
  <div class="demo-test-area--wrapper" :style="{color: textColor}">
    <div class="demo-test-area--title">
      <div class="demo-test-area--title-main" :style="{color: linkColor}">4kapa.pl Chat by Vue.js</div>
      <div class="demo-test-area--title-sub">made by <a :style="{color: linkColor}" href="https://github.com/superAdam47">Boris</a></div>
    </div>
    <form class="demo-test-area" @submit.prevent="_handleSubmit" @keyup="_handleTyping">
      <div class="demo-test-area--preamble">
        <p>możesz tutaj przetestować czat między administratorem a klientem:</p>
